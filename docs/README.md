...
Start with the root [README](../README.md) for installation, architecture and
the canonical test command. Project-wide operating procedures live here;
extension-specific behaviour remains in each extension repository.
...
| [typo3-agent.md](typo3-agent.md) | Upstream backend chatbot, model configuration and spreadsheet compatibility. |
...
| [eu-sovereign-reference-architecture.md](eu-sovereign-reference-architecture.md) | EU-sovereign deployment reference. |
