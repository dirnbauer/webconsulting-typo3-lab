...
| `hn/typo3-agent` (installed 2026-09-16) | Upstream backend chat with tasks, attachments, and native MCP tool execution. Replaces the Webconsulting chat fork; see [configuration](typo3-agent.md) — item 11 |
