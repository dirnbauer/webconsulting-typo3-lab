        ...
        return [
            [
                ...
                'fixture' => [
                    ...
                    'lead' => 'Two hundred and fifty content elements built on Astryx — the open-source design system Meta released under MIT. Twenty-five themes, light and dark, and not one line of React on the page your visitor loads.',
                    'cta_label' => 'See all 250 elements',
                    'cta_link' => 't3://page?uid=__HUB__',
                    'secondary_label' => 'Compare all twenty-five themes',
            ...
            [
                ...
                'fixture' => [
                    ...
                    'lead' => 'Desiderio Grande is GPL-2.0-or-later, like TYPO3 itself: all 250 elements, all twenty-five themes, the seeding commands and the audit scripts, complete and at no cost. The paid tiers buy response times and the people who built it — never a feature that was withheld.',
        ...
        return [
            ...
            'accessibility' => [
                ...
                'bodytext' => '<p>The theme is built to work without a mouse and without sight of the layout. Every page has one h1 that says what the page is; content elements head their own band with an h2, so the outline reads as a table of contents.</p>'
                    . '<p>Focus is always visible, and the accent-coloured ring is drawn from the same token as the rest of the theme, so it stays visible in every one of the twenty-five themes and in both colour schemes.</p>'
                    . '<p>Contrast is measured rather than assumed. A script checks all 1,500 colour pairs the stylesheets declare — twenty-five themes in light and dark — against the WCAG 2.2 AA thresholds of 4.5:1 for body text and 3:1 for boundaries, focus rings and meaningful graphics, and the build fails if a single pair misses. Where Astryx\'s own palette values fall short, a generated corrections file lifts only the failing colour, and only as far as the threshold.</p>'
