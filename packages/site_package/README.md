...
| Site Sets | Six Site Sets covering base defaults, search, Blog, Blog Bootstrap, Camino, and Desiderio Corporate. |
...
| Desiderio | Shared partial/template path overrides for EXT:news, EXT:blog, Blog, and Desiderio Corporate rendering. |
...
| `config/sites/mtug-camp-munich-2026` | `webconsulting/site-package-desiderio-corporate` plus `desiderio/content-blocks-bundle` |

## Related Desiderio Sites

The following Desiderio sites are part of the same TYPO3 lab but do not depend
on this local site package set yet:
...
Package-level changes here do not automatically affect those sites unless their
Site Set dependencies are adjusted.
