...
final class SkillSecurityScanner
{
    ...
    private const RULES = [
        ...
        [
            ...
            'id' => 'destructive_catastrophic', 'severity' => Severity::Danger, 'category' => 'Catastrophic filesystem/device command',
        ...
        [
            ...
            'id' => 'destructive_fs', 'severity' => Severity::Warning, 'category' => 'Destructive command',
        ...
        [
            'id' => 'fork_bomb', 'severity' => Severity::Danger, 'category' => 'Fork bomb',
            'pattern' => '~:\s*\(\s*\)\s*\{\s*:\s*\|\s*:\s*&\s*\}\s*;\s*:~',
            'check' => 'This is a shell fork bomb. Verify it is quoted as an example of what to avoid, not runnable copy-paste.',
        ],
        [
            'id' => 'pipe_to_shell', 'severity' => Severity::Danger, 'category' => 'Remote code execution',
        ...
        [
            ...
            'id' => 'code_eval', 'severity' => Severity::Warning, 'category' => 'Dynamic code execution',
        ...
        [
            'id' => 'obfuscation', 'severity' => Severity::Warning, 'category' => 'Obfuscated code',
        ...
        [
            'id' => 'sql_concat', 'severity' => Severity::Info, 'category' => 'Possible SQL injection',
        ...
        [
            'id' => 'private_key', 'severity' => Severity::Danger, 'category' => 'Exposed private key',
        ...
        [
            'id' => 'api_key', 'severity' => Severity::Danger, 'category' => 'Exposed API credential',
        ...
        [
            'id' => 'hardcoded_secret', 'severity' => Severity::Warning, 'category' => 'Hard-coded secret',
        ...
        // --- Data exfiltration ---------------------------------------------
        [
            'id' => 'exfiltration_endpoint', 'severity' => Severity::Danger, 'category' => 'Data exfiltration endpoint',
        ...
        [
            'id' => 'instruction_override', 'severity' => Severity::Warning, 'category' => 'Prompt injection',
        ...
        [
            'id' => 'reveal_prompt', 'severity' => Severity::Warning, 'category' => 'Prompt injection',
        ...
        [
            'id' => 'safety_bypass', 'severity' => Severity::Warning, 'category' => 'Agent subversion',
        ...
        [
            'id' => 'unattended_write', 'severity' => Severity::Info, 'category' => 'Autonomy prompt',
