...
The local package `webconsulting/site-package` is versioned as `14.0.0`,
supports TYPO3 `14.3.0-14.99.99`, and replaces the former
...
| `webconsulting/site-package-blog` | Blog standalone rendering with Desiderio template paths. |
...
| `webconsulting/site-package-desiderio-corporate` | Desiderio corporate rendering with Shadcn UI templates. |

### Configured Demo Sites

| Site config | Local URL | Root page | Languages | Site Set dependencies |
|---|---|---:|---|---|
| `config/sites/camino` | `/` | `99` | English | `webconsulting/site-package-camino` |
| `config/sites/blog` | `/autogenerated-15` | `15` | German, English, Chinese | `georgringer/news`, `webconsulting/site-package-blog` |
...
| `config/sites/mattersburg-sights` | `/mattersburg/` | `639` | German, English, Hungarian | `webconsulting/site-package-desiderio-corporate` |
| `config/sites/typo3-vienna-camp-2026` | `/typo3-vienna-camp-2026/` | `505` | English, German, Chinese, Hungarian | `webconsulting/desiderio-content-elements`, `webconsulting/desiderio-powermail` |
| `config/sites/mtug-camp-munich-2026` | `/mtug-camp-munich-2026/` | `686` | German, English, Hungarian | `webconsulting/site-package-desiderio-corporate`, `desiderio/content-blocks-bundle` |
...
| `webconsulting/site-package` | `^14.0` | Local site package with shared Site Sets and defaults. |
...
| `blog/standalone` | `webconsulting/site-package-blog` |
| `blog/bootstrap-53` | `webconsulting/site-package-blog-bootstrap` |
| `webconsulting/desiderio-preset-corporate` | `webconsulting/site-package-desiderio-corporate`, `config/sites/eurovision2026` |
| `webconsulting/desiderio-shadcnui-templates` | `webconsulting/site-package-desiderio-corporate` |
...
```bash
for url in / /14/ /autogenerated-15/ /autogenerated-390/ /mattersburg/ /typo3-vienna-camp-2026/ /mtug-camp-munich-2026/; do
